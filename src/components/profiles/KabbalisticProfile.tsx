    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4">
            ...
            <div className="flex overflow-x-auto gap-4 no-scrollbar pb-6 -mx-4 px-4">
                {insight.activeSefirotOrNodes && insight.activeSefirotOrNodes.length > 0 ? insight.activeSefirotOrNodes.map((node, i: number) => (
                    ...
                    <div className="text-white/40 text-center w-full">Aligning spiritual nodes...</div>
                )}
            </div>
        </div>
    </div>
