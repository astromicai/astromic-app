    ...
    return (
      <div className="flex-1 flex flex-col px-6 pt-10 pb-8 relative z-[20]">
        ...
        <div className="mb-10">
          ...
          <p className="text-white/60 text-base">Location allows us to calculate your exact planetary degrees.</p>
        </div>
        ...
        <div className="mt-auto">
          <button 
            disabled={!userData.birthPlace.trim()}
            onClick={onNext} 
            className="w-full h-14 bg-primary text-white font-bold text-lg rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 group disabled:opacity-50"
          >
            Continue
            <span className="material-symbols-outlined group-hover:translate-x-1 transition-transform">arrow_forward</span>
          </button>
