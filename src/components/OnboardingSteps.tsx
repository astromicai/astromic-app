    ...
    return (
      <div className="flex-1 flex flex-col justify-between items-center px-6 py-8">
        ...
        <div className="flex-1 flex flex-col items-center justify-center w-full -mt-10">
          <div className="w-full max-w-[360px] aspect-square relative mb-8 flex items-center justify-center">
            {/* New Hero Image with Float Animation */}
            <div className="relative w-full h-full animate-float">
              <img
                src="/hero_quantum_processor.svg"
                alt="AI Quantum Processor"
                className="w-full h-full object-contain drop-shadow-[0_0_50px_rgba(34,211,238,0.6)]"
              />
            </div>
          </div>
